...
IDN:w13{ name:"Reconciliación Down-Top de Estado", file:"workflows/w13-reconcile-down-top.md", purpose:"Mantener estado consistente entre tasks/BLPs/ciclos/brain/meta-brain. Cada mutación atómica reconcilia el ciclo. El proyecto/workspace se reconcilia por contexto.", trigger:"Mutación en task/blueprint/ciclo, o sync.reconcile() manual." }