...
handler_schemas = [
    ...
    {"name": "blueprint.ready", "fn": ready_blueprint, "description": "Architect declares Blueprint ready for execution. draft → ready.", "input_schema": {"type": "object", "properties": {"bp_id": {"type": "string"}, "cycle": {"type": "string"}, "path": {"type": "string"}}, "required": ["bp_id"]}},
    {"name": "blueprint.claim", "fn": claim_blueprint, "description": "Executor claims the Blueprint. ready → in_progress + implicit executor assignment.", "input_schema": {"type": "object", "properties": {"bp_id": {"type": "string"}, "cycle": {"type": "string"}, "path": {"type": "string"}}, "required": ["bp_id"]}},
    ...
    {"name": "blueprint.update", "fn": update_blueprint, "description": "Update Blueprint progress with a note or refine a single section.", "input_schema": {"type": "object", "properties": {"bp_id": {"type": "string"}, "note": {"type": "string", "description": "Progress note to append"}, "section": {"type": "string", "description": "Section number like '§3' or '3'"}, "content": {"type": "string", "description": "Section content (text or markdown)"}, "puml": {"type": "string", "description": "PlantUML source for diagram sections"}, "cycle": {"type": "string"}, "path": {"type": "string"}}, "required": ["bp_id"]}},
    {"name": "blueprint.complete", "fn": complete_blueprint, "description": "Declare execution complete. in_progress → done (completado + aprobado en 1 paso).", "input_schema": {"type": "object", "properties": {"bp_id": {"type": "string"}, "evidence": {"type": "string"}, "cycle": {"type": "string"}, "path": {"type": "string"}}, "required": ["bp_id"]}},
    {"name": "blueprint.cancel", "fn": cancel_blueprint, "description": "Cancel a Blueprint. Governor-only. State → cancelled.", "input_schema": {"type": "object", "properties": {"bp_id": {"type": "string"}, "reason": {"type": "string"}, "cycle": {"type": "string"}, "path": {"type": "string"}}, "required": ["bp_id"]}},
    {"name": "blueprint.fail", "fn": fail_blueprint, "description": "Blueprint hit an obstacle. State → blocked.", "input_schema": {"type": "object", "properties": {"bp_id": {"type": "string"}, "reason": {"type": "string"}, "cycle": {"type": "string"}, "path": {"type": "string"}}, "required": ["bp_id", "reason"]}},
    {"name": "blueprint.re_delegate", "fn": re_delegate_blueprint, "description": "Re-delegate after verification failure. Re-opens a done/blocked blueprint.", "input_schema": {"type": "object", "properties": {"bp_id": {"type": "string"}, "cycle": {"type": "string"}, "path": {"type": "string"}}, "required": ["bp_id"]}},
    {"name": "blueprint.block_for_architect", "fn": block_for_architect, "description": "Block for Architect manual review.", "input_schema": {"type": "object", "properties": {"bp_id": {"type": "string"}, "cycle": {"type": "string"}, "path": {"type": "string"}}, "required": ["bp_id"]}},
    {"name": "blueprint.read", "fn": read_blueprint, "description": "Read a full Blueprint (HCORTEX or CORTEX format).", "input_schema": {"type": "object", "properties": {"bp_id": {"type": "string"}, "format": {"type": "string", "enum": ["hcortex", "cortex"], "default": "hcortex"}, "cycle": {"type": "string"}, "path": {"type": "string"}}, "required": ["bp_id"]}},
