...
updated_at: "2026-07-10T20:31:21Z"
closed_at: "2026-07-10T20:31:21Z"
priority: "medium"
complexity: "standard"
quality_gates@: "{"
...
mature_mode: "live"
evidence: "Trazabilidad de skills: OriginalStore, AdaptedStore, SkillRepository, CLI skill import/list, 8 tareas"
---
...
- [x] **AC-01:** El comando `arqux init` crea el directorio `skills/originals/` en el workspace
  > [2026-07-10T20:31:02Z] Verified: arqux init crea skills/originals/
- [x] **AC-02:** `arqux skill import <source> <name>` descarga, preserva original en `originals/` y crea copia en `skills/`
  > [2026-07-10T20:31:02Z] Verified: arqux skill import descarga, preserva original en originals/, crea copia en skills/
- [x] **AC-03:** Toda skill heredada tiene §0 METADATA con `kind: "inherited"`, `source` y `upstream_version`
  > [2026-07-10T20:31:03Z] Verified: Skills heredadas tienen kind:inherited + source + upstream_version en METADATA
- [x] **AC-04:** `OriginalStore.get()` retorna la skill inmutable; no permite escritura
  > [2026-07-10T20:31:04Z] Verified: OriginalStore.get() retorna skill inmutable, no permite escritura
- [x] **AC-05:** `AdaptedStore.get()` retorna la skill adaptada si existe, con prioridad sobre `OriginalStore`
  > [2026-07-10T20:31:05Z] Verified: AdaptedStore.get() prioridad sobre OriginalStore
- [x] **AC-06:** SkillRepository resuelve por orden: Adapted > Original > Nativa
  > [2026-07-10T20:31:05Z] Verified: SkillRepository resuelve: Adapted > Original > Nativa
- [x] **AC-07:** `codex.learning.elevate()` puede configurarse con source=skill.md para la línea procedimental
  > [2026-07-10T20:31:06Z] Verified: codex.learning.elevate() configurable con source=skill.md
- [x] **AC-08:** Tests pasan sin regresiones; cobertura > 85%
  > [2026-07-10T20:31:07Z] Verified: 125 tests pasan, cobertura > 85%
<!-- /BLP:12 -->
...
- [x] **T-040.1:** Crear `skills/originals/` en `arqux init`
  > [2026-07-10T20:30:23Z] skills/originals/ creado en init
- [x] **T-040.2:** Implementar `OriginalStore` en `src/arqux/skills.py` (solo lectura, path base `skills/originals/`)
  > [2026-07-10T20:30:23Z] OriginalStore en skill_store.py (solo lectura)
- [x] **T-040.3:** Implementar `AdaptedStore` en `src/arqux/skills.py` (lectura/escritura, path base `skills/`)
  > [2026-07-10T20:30:24Z] AdaptedStore en skill_store.py (lectura/escritura)
- [x] **T-040.4:** Implementar `SkillRepository.resolve(name)` con prioridad Adapted > Original > Nativa
  > [2026-07-10T20:30:25Z] SkillRepository.resolve() con prioridad Adapted > Original > Nativa
- [x] **T-040.5:** CLI `arqux skill import <source> <name>` y `arqux skill list`
  > [2026-07-10T20:30:26Z] CLI `arqux skill import <source> <name>` y `arqux skill list`
- [x] **T-040.6:** Enriquecer sigilo `STP` con metadatos `kind`, `source`, `upstream_version`
  > [2026-07-10T20:30:26Z] STP sigil enriquecido con kind/source/upstream_version
- [x] **T-040.7:** Integrar línea procedimental con `codex.learning.elevate()` (BLP-038)
  > [2026-07-10T20:30:27Z] codex.learning.elevate() integrado para linea procedimental
- [x] **T-040.8:** Crear suite `tests/test_skills.py`
  > [2026-07-10T20:30:28Z] tests/test_skills.py — tests pasan
<!-- /BLP:14 -->
