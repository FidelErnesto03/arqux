...
closed_at: "2026-07-10T15:52:43Z"
priority: "medium"
complexity: "standard"
quality_gates@: "{"
...
- [ ] **AC-01:** Validador usa `level` de §0 METADATA (validado por BLP-035)
- [ ] **AC-02:** Validador detecta BRAIN zombie (sin FCS activo)
- [ ] **AC-03:** Validador detecta BRAIN con secciones faltantes
- [ ] **AC-04:** Validador pasa para archivos correctamente formateados
- [ ] **AC-05:** Tests cubren los 4 niveles
- [ ] **AC-06:** Cobertura > 85%
<!-- /BLP:12 -->
...
- [ ] **T-036.1:** Crear `src/arqux/validators/__init__.py` con interfaz base
- [ ] **T-036.2:** Implementar `brain_validator.py` con validación de §0 METADATA + zombie + anatomía
- [ ] **T-036.3:** Crear `tests/test_validators.py` con fixtures
- [ ] **T-036.4:** Integrar validador en handlers MCP (lectura)
<!-- /BLP:14 -->
