...
updated_at: "2026-07-07T16:34:23Z"
closed_at: ""
priority: "high"
complexity: "standard"
quality_gates: ""
...
- [ ] **AC-01:** 100+ tests pasando
- [ ] **AC-02:** Tests existentes no rompen
- [ ] **AC-03:** `test_session.py` con 6 tests
- [ ] **AC-04:** `test_learn_trigger.py` con 4 tests
- [ ] **AC-05:** `test_mode_live.py` con 4 tests
- [ ] **AC-06:** `test_validate_file.py` con 4 tests
- [ ] **AC-07:** `test_gate.py` con 3 tests
...
- [ ] **T-1:** Crear `test_session.py` (6 tests)
- [ ] **T-2:** Crear `test_learn_trigger.py` (4 tests)
- [ ] **T-3:** Crear `test_mode_live.py` (4 tests)
- [ ] **T-4:** Crear `test_validate_file.py` (4 tests)
- [ ] **T-5:** Crear `test_gate.py` (3 tests)
- [ ] **T-6:** Verificar suite completa ≥ 100 tests
