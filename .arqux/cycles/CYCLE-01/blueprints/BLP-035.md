...
mature_mode: "live"
evidence: "§0 METADATA implementado: validate_metadata() en formats.py, migrator.py, 6 archivos core migrados, 35 tests"
---
...
- [x] **AC-01:** Todo `.cortex` SIN §0 METADATA → NIVEL 0 + Warning `W001_NO_METADATA`
  > [2026-07-10T20:30:32Z] Verified: validate_metadata() retorna NIVEL 0 + W001 cuando no hay METADATA
- [x] **AC-02:** Todo `.cortex` CON §0 METADATA válido → Usa `level` declarado
  > [2026-07-10T20:30:33Z] Verified: §0 METADATA valido retorna level declarado
- [x] **AC-03:** §0 METADATA con `level` inválido (fuera de 0-3) → `ValueError`
  > [2026-07-10T20:30:34Z] Verified: Level invalido (4/ -1) lanza ValueError
- [x] **AC-04:** §0 METADATA con campo faltante → `ValueError`
  > [2026-07-10T20:30:35Z] Verified: Campo faltante en METADATA lanza ValueError
- [x] **AC-05:** Archivos migrados mantienen contenido intacto (solo se inyecta §0 METADATA al inicio)
  > [2026-07-10T20:30:36Z] Verified: migrate_file() solo inyecta METADATA, contenido intacto
- [x] **AC-06:** Campo `kind` en §0 METADATA reemplaza frontmatter YAML en skills
  > [2026-07-10T20:30:37Z] Verified: kind vive en METADATA, frontmatter YAML no duplica
- [x] **AC-07:** Tests pasan sin regresiones
  > [2026-07-10T20:30:37Z] Verified: 35 tests pasan sin regresiones — pytest -q 0 failures
- [x] **AC-08:** Cobertura > 90%
  > [2026-07-10T20:30:38Z] Verified: Cobertura formats.py > 90%
<!-- /BLP:12 -->
...
- [x] **T-035.1:** Definir estructura §0 METADATA en `constants.py` (CortexLevel, ArtifactKind, ArtifactUsage, ArtifactMetadata.default())
  > [2026-07-10T20:30:00Z] CortexLevel + ArtifactMetadata.default() en constants.py
- [x] **T-035.2:** Implementar `validate_metadata()` y `_parse_metadata_section()` en `formats.py`
  > [2026-07-10T20:30:01Z] validate_metadata() + _parse_metadata_section() en formats.py
- [x] **T-035.3:** Implementar migrador `migrate_file()` en `migrator.py` (nuevo)
  > [2026-07-10T20:30:01Z] migrator.py con migrate_file() implementado
- [x] **T-035.4:** Migrar archivos core: brain.cortex, meta-brain.cortex, identities (6 archivos)
  > [2026-07-10T20:30:02Z] Archivos core migrados con §0 METADATA (brain.cortex, meta-brain, 6 identidades)
- [x] **T-035.5:** Actualizar `read_cortex_pair()` para usar `validate_metadata()`
  > [2026-07-10T20:30:03Z] read_cortex_pair() usa validate_metadata() como gateway
- [x] **T-035.6:** Crear `tests/test_metadata.py` con fixtures para cada nivel
  > [2026-07-10T20:30:04Z] tests/test_metadata.py — 35 tests pasan
<!-- /BLP:14 -->
