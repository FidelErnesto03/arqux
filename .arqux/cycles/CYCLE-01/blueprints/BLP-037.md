...
mature_mode: "live"
evidence: "BrainActiveStateValidator: VALID_STATUSES, E024/E028, 22 tests"
---
...
- [x] **AC-01:** E024 si `$3` no contiene FCS
  > [2026-07-10T20:30:43Z] Verified: E024 si $3 no contiene FCS
- [x] **AC-02:** E024 si todos FCS tienen `status: "done"`
  > [2026-07-10T20:30:44Z] Verified: E024 si todos FCS tienen status:done
- [x] **AC-03:** FCS con `status: "blocked"` es considerado válido
  > [2026-07-10T20:30:45Z] Verified: FCS con status:blocked es considerado valido
- [x] **AC-04:** E028 si no hay objetivos vigentes en `$4`
  > [2026-07-10T20:30:45Z] Verified: E028 si no hay objetivos vigentes en $4
- [x] **AC-05:** ValidatorFactory ejecuta semántica solo si estructural pasó
  > [2026-07-10T20:30:46Z] Verified: ValidatorFactory ejecuta semantica solo si estructural paso
<!-- /BLP:12 -->
...
- [x] **T-037.1:** Definir `VALID_STATUSES` e `INVALID_STATUSES` en `constants.py`
  > [2026-07-10T20:30:08Z] VALID_STATUSES / INVALID_STATUSES frozensets en constants.py
- [x] **T-037.2:** Implementar `BrainActiveStateValidator` en `brain_semantics.py` usando `crud_read()`
  > [2026-07-10T20:30:09Z] BrainActiveStateValidator en brain_semantics.py
- [x] **T-037.3:** Integrar en `ValidatorFactory` para `CortexLevel.BRAIN`
  > [2026-07-10T20:30:09Z] ValidatorFactory ejecuta BrainActiveStateValidator para level=BRAIN
- [x] **T-037.4:** Crear `tests/test_brain_semantics.py`
  > [2026-07-10T20:30:10Z] tests/test_brain_semantics.py — 22 tests pasan
<!-- /BLP:14 -->
