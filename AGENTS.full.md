...
AXM:delta_full{This file is a DELTA over AGENTS.lite.md. Load AGENTS.md+AGENTS.lite.md first. Does NOT repeat NANO or LITE content. Only load if context window >250K. Discover handlers dynamically via handler.list(tier=FULL).}
